...
# DESCRIPTION
# ----------------------------------------------------------------------------------------------------
## @file    extPySide2Windows/packageEnvLib.py @brief [ FILE   ] - Package environment module.
## @package extPySide2Windows.packageEnvLib    @brief [ MODULE ] - Package environment module.
